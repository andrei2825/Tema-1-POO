...
public class Recommendations {
    public String  recommendation(ActionInputData action,
    ...
    private String  standardMethod(ActionInputData action,
                                   ArrayList<Movie> movies, ArrayList<Show> shows, ArrayList<User> users) {
        for (User user : users) {
    ...
    private String  bestUnseenMethod(ActionInputData action,
                                   ArrayList<Movie> movies, ArrayList<Show> shows, ArrayList<User> users) {
    ...
    private String  popularMethod(ActionInputData action,
                                  ArrayList<Movie> movies, ArrayList<Show> shows, ArrayList<User> users) {
        for (User user : users) {
            if (user.getUsername().equals(action.getUsername())) {
    ...
    private String  searchMethod(ActionInputData action,
                                   ArrayList<Movie> movies, ArrayList<Show> shows, ArrayList<User> users) {
        for (User user : users) {
            if (user.getUsername().equals(action.getUsername())) {
                if (user.getSubscriptionType().equals("BASIC")) {
